...
for pars_idx in pars_idc:
    ...
    plot_crocker_highres_split(true_crocker,
                               ...
                               [50,150,250],
                               [Cval,Lval,Wval],
                                           save_path='./Simulated_Grid/ODE_Align/Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'/run_1/true_crocker_'+'Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'_angles_OGw05.pdf')

    # load median values
    median_path = './Simulated_Grid/ODE_Align/Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'/run_1/medians_OGw05.npy'
    ...
    ABC_crocker = compute_crocker_custom(ABC_df,pred_FRAME_LIST,PROX_VEC,data_cols=DATA_COLS,betti=[0,1])
    plot_crocker_highres_split(ABC_crocker,
                               ...
                               [50,150,250],
                               medians,
                               save_path='./Simulated_Grid/ODE_Align/Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'/run_1/ABC_crocker_'+'Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'_angles_OGw05.pdf')
