...
def run_save_crocker(args):
    ...
    if 'vx' in DATA_COLS:
        SAVE_PATH = './Simulated_Grid/ODE_Align/Cidx_'+str(C_idx).zfill(2)+'_Lidx_'+str(L_idx).zfill(2)+'_Widx_'+str(W_idx).zfill(2)+'/run_1/crocker_velocities.npy'
    if 'angle' in DATA_COLS:
        SAVE_PATH = './Simulated_Grid/ODE_Align/Cidx_'+str(C_idx).zfill(2)+'_Lidx_'+str(L_idx).zfill(2)+'_Widx_'+str(W_idx).zfill(2)+'/run_1/crocker_angles.npy'
