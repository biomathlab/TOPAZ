...
#     plt.suptitle(f'(ABC-Threshold = {distance_threshold})\n', fontsize=15,  y=0.5)
    ...
    fig.tight_layout()
    fig.savefig('./Simulated_Grid/ODE_Align/Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'/run_1/ABC_'+'Cidx_'+str(Cidx).zfill(2)+'_Lidx_'+str(Lidx).zfill(2)+'_Widx_'+str(Widx).zfill(2)+'_angles_OGw00.pdf',bbox_inches='tight')
